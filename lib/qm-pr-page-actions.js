...
(function attach(scope) {
  ...
  function showRebaseConfirmModal({ doc = document, trigger } = {}) {
    return new Promise((resolve) => {
      ...
      // Verbatim from github_power_suite_docs_updated/pr_page_rebase_button.md
      // §Safety Copy. The doc-exact string keeps reviewer + UX expectations
      // aligned with the original spec; do not paraphrase here.
      body.textContent = "This may update the branch and retrigger CI. Continue?";
