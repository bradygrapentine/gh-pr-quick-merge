...
(function attach(scope) {
  ...
  const CHIPS = [
    { key: "mine", label: "Mine", kind: "include" },
    { key: "ready", label: "Ready", kind: "include" },
    { key: "stale", label: "Stale", kind: "include" },
    { key: "small", label: "Small", kind: "include" },
    // Track C noise toggles — exclusion chips, visually distinct.
    { key: "hideDependabot", label: "Hide bots", kind: "exclude" },
    { key: "hideDrafts", label: "Hide drafts", kind: "exclude" },
  ];
