...
(function attach(scope) {
  ...
  // Default-visible chips. Stale + Small + Hide drafts hide behind a
  // "More" disclosure to keep the bar quiet — they're still toggleable
  // and their state still applies to filtering.
  const CHIPS = [
